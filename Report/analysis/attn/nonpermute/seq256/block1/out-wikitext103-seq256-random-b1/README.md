# out-wikitext103-seq256-random-b1

This directory stores block-attention analysis for the checkpoint
`/home/devbox/project/AOGPT-test-order/nanogpt_learned_order/out/base/nonpermute/seq256/block1/out-wikitext103-seq256-random-b1/ckpt.pt` evaluated with `mode=Random`.
