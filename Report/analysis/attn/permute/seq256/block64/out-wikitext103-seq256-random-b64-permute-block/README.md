...
`/home/devbox/project/AOGPT-test-order/nanogpt_learned_order/out/base/permute/seq256/block64/out-wikitext103-seq256-random-b64-permute-block/ckpt.pt` evaluated with `mode=Random`.
