...
# Usage:
#   python scripts/runner/segment_curriculum_runner.py config/WikiText103/seq512/non_permute/block64/segment_curriculum.py

config = 'config/WikiText103/seq512/non_permute/block64/random.py'

train_out_dir = 'out/curriculum/nonpermute/seq512/block64/out-wikitext103-seq512-random-b64-curriculum'
benchmark_root = 'Report/curriculum/nonpermute/seq512/block64/block64'

wandb_project = 'AOGPT-order-block'
wandb_run_name = 'seq512-random-b64-curriculum'
