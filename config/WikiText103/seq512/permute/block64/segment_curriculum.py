...
# Usage:
#   python scripts/runner/segment_curriculum_runner.py config/WikiText103/seq512/permute/block64/segment_curriculum.py

config = 'config/WikiText103/seq512/permute/block64/random.py'

train_out_dir = 'out-wikitext103-seq512-random-b64-curriculum-permute-block'
benchmark_root = 'Report/curriculum/seq512/permute/block64'
