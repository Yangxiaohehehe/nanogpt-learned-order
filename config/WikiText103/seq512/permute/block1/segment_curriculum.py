...
# Usage:
#   python scripts/runner/segment_curriculum_runner.py config/WikiText103/seq512/permute/block1/segment_curriculum.py

config = 'config/WikiText103/seq512/permute/block1/random.py'

train_out_dir = 'out/curriculum/permute/seq512/block1/out-wikitext103-seq512-random-b1-curriculum-permute-block'
benchmark_root = 'Report/curriculum/permute/seq512/block1/block1'

wandb_project = 'AOGPT-order-block'
wandb_run_name = 'seq512-random-b1-permute-curriculum'
