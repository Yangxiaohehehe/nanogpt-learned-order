# Early-signal scan preset for block32 random permute-block training.
# This keeps iteration-named checkpoints so they can be batch-benchmarked later.

out_dir = 'out-wikitext103-random-b32-permute-block-early-scan'
eval_interval = 500
eval_iters = 200
log_interval = 10
...
wandb_run_name = 'wikitext103-random-b32-permute-block-early-scan'
...
save_iter_checkpoint_dir = 'out-wikitext103-random-b32-permute-block-early-scan/checkpoints'
