...
# Usage:
#   python scripts/runner/segment_curriculum_runner.py config/WikiText103/seq256/non_permute/block1/segment_curriculum.py

config = 'config/WikiText103/seq256/non_permute/block1/random.py'

train_out_dir = 'out/curriculum/nonpermute/seq256/block1/out-wikitext103-seq256-random-b1-curriculum'
benchmark_root = 'Report/curriculum/nonpermute/seq256/block1/block1'

wandb_project = 'AOGPT-order-block'
wandb_run_name = 'seq256-random-b1-curriculum'
