...
# Usage:
#   python scripts/runner/segment_curriculum_runner.py config/WikiText103/seq256/non_permute/block64/segment_curriculum.py

config = 'config/WikiText103/seq256/non_permute/block64/random.py'

train_out_dir = 'out/curriculum/nonpermute/seq256/block64/out-wikitext103-seq256-random-b64-curriculum'
benchmark_root = 'Report/curriculum/nonpermute/seq256/block64/block64'

wandb_project = 'AOGPT-order-block'
wandb_run_name = 'seq256-random-b64-curriculum'
