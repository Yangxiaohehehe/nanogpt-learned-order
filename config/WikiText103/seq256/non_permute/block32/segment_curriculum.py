...
# Usage:
#   python scripts/runner/segment_curriculum_runner.py config/WikiText103/seq256/non_permute/block32/segment_curriculum.py

config = 'config/WikiText103/seq256/non_permute/block32/random.py'

train_out_dir = 'out/curriculum/nonpermute/seq256/block32/out-wikitext103-seq256-random-b32-curriculum'
benchmark_root = 'Report/curriculum/nonpermute/seq256/block32/block32'

wandb_project = 'AOGPT-order-block'
wandb_run_name = 'seq256-random-b32-curriculum'
