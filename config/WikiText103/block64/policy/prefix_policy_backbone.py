# Train the backbone with top-k prefix policy orders from a frozen order head in the 64-block setup.
...
wandb_run_name = 'wikitext103-prefix-policy-backbone-b64'
